...
## Set multiple values for individual EWMA chart ARL_0 =740, 1480, 2220
Lx1_U <- c(2.89,3.13,3.26) ; Lp1_U <- c(3.12,3.37,3.48) ; Lc1_U <- c(3.10,3.38,3.54)
L1_U <- matrix(rbind(Lx1_U,Lp1_U,Lc1_U),3,3)
#L1_U <- L1_U + 0.01

Lx2_U <- c(2.89,3.13,3.26) ; Lp2_U <- c(3.12,3.37,3.48) ; Lc2_U <- c(3.10,3.38,3.54)
L2_U <- matrix(rbind(Lx2_U,Lp2_U,Lc2_U),3,3)
#L2_U <- L2_U + 0.01

Lx3_U <- c(2.89,3.13,3.26) ; Lp3_U <- c(3.12,3.37,3.48) ; Lc3_U <- c(3.10,3.38,3.54)
L3_U <- matrix(rbind(Lx3_U,Lp3_U,Lc3_U),3,3)
#L3_U <- L3_U + 0.01

Lx4_U <- c(2.89,3.13,3.26) ; Lp4_U <- c(3.12,3.37,3.48) ; Lc4_U <- c(3.10,3.38,3.54)
...
## Set multiple values for individual EWMA chart ARL_0 =740, 1480, 2220
Lx1_L <- c(-2.89,-3.13,-3.25) ; Lp1_L <- c(-2.32,-2.42,-2.46) ; Lc1_L <- c(-2.66,-2.85,-2.95)
L1_L <- matrix(rbind(Lx1_L,Lp1_L,Lc1_L),3,3)
#L1_L <- L1_L - 0.01*1

Lx2_L <- c(-2.89,-3.13,-3.25) ; Lp2_L <- c(-2.32,-2.42,-2.46) ; Lc2_L <- c(-2.66,-2.85,-2.95)
L2_L <- matrix(rbind(Lx2_L,Lp2_L,Lc2_L),3,3)
#L2_L <- L2_L - 0.01*1

Lx3_L <- c(-2.89,-3.13,-3.25) ; Lp3_L <- c(-2.32,-2.42,-2.46) ; Lc3_L <- c(-2.66,-2.85,-2.95)
L3_L <- matrix(rbind(Lx3_L,Lp3_L,Lc3_L),3,3)
#L3_L <- L3_L - 0.01*1

Lx4_L <- c(-2.89,-3.13,-3.25) ; Lp4_L <- c(-2.32,-2.42,-2.46) ; Lc4_L <- c(-2.66,-2.85,-2.95)
