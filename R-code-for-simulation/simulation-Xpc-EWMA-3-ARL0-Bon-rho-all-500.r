...
## Set multiple values for individual EWMA chart ARL_0 =1000, 2000, 3000
Lx1_U <- c(3.00,3.22,3.35) ; Lp1_U <- c(3.22,3.46,3.58) ; Lc1_U <- c(3.23,3.50,3.65)
L1_U <- matrix(rbind(Lx1_U,Lp1_U,Lc1_U),3,3)
L1_U <- L1_U - 0.01

Lx2_U <- c(3.00,3.22,3.35) ; Lp2_U <- c(3.22,3.46,3.58) ; Lc2_U <- c(3.23,3.50,3.65)
L2_U <- matrix(rbind(Lx2_U,Lp2_U,Lc2_U),3,3)
L2_U <- L2_U + 0.01

Lx3_U <- c(3.00,3.22,3.35) ; Lp3_U <- c(3.22,3.46,3.58) ; Lc3_U <- c(3.23,3.50,3.65)
L3_U <- matrix(rbind(Lx3_U,Lp3_U,Lc3_U),3,3)
#L3_U <- L3_U - 0.01

Lx4_U <- c(3.00,3.22,3.35) ; Lp4_U <- c(3.22,3.46,3.58) ; Lc4_U <- c(3.23,3.50,3.65)
...
## Set multiple values for individual EWMA chart ARL_0 =1000, 2000, 3000
Lx1_L <- c(-3.00,-3.22,-3.35) ; Lp1_L <- c(-2.36,-2.45,-2.50) ; Lc1_L <- c(-2.74,-2.93,-3.03)
L1_L <- matrix(rbind(Lx1_L,Lp1_L,Lc1_L),3,3)
L1_L <- L1_L + 0.01*1

Lx2_L <- c(-3.00,-3.22,-3.35) ; Lp2_L <- c(-2.36,-2.45,-2.50) ; Lc2_L <- c(-2.74,-2.93,-3.03)
L2_L <- matrix(rbind(Lx2_L,Lp2_L,Lc2_L),3,3)
L2_L <- L2_L - 0.01*1

Lx3_L <- c(-3.00,-3.22,-3.35) ; Lp3_L <- c(-2.36,-2.45,-2.50) ; Lc3_L <- c(-2.74,-2.93,-3.03)
L3_L <- matrix(rbind(Lx3_L,Lp3_L,Lc3_L),3,3)
#L3_L <- L3_L + 0.01*1

Lx4_L <- c(-3.00,-3.22,-3.35) ; Lp4_L <- c(-2.36,-2.45,-2.50) ; Lc4_L <- c(-2.74,-2.93,-3.03)
...
for(d in 1:length(rho123)){
  ...
  #write_csv(c_df ,file=paste("result/one-side-EWMA/RL/Xpc-ARL0-Bon-all-RL-all-",d,".csv",
...
df
write_csv(df,file=paste("result/one-side-EWMA/Xpc-ARL0-Bon-all.csv",sep = ""),
